...
class AutoAddUfUfCitycodeToEntityHlblock4520190809130313669249 extends BitrixMigration
{
    /**
     * Run the migration.
     *
  ...
  array (
    ...
    {
        $id = $this->getUFIdByCode('HLBLOCK_45', 'UF_CITYCODE');
        if (!$id) {
