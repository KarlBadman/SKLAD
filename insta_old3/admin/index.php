...
/*
echo "<pre>";
print_r($maininsta->chtenie("1.txt")[0]);
echo "</pre>";


foreach ($maininsta->chtenie("1.txt")[0] as $massfoto) {
    $formirtablic .= "
        <tr>
            <td><img src='".$massfoto['maloe']."'</td>
            <td>".$massfoto['laiki']."</td>
            <td>".$massfoto['adresfoto']."</td>
        </tr>
    ";
}
*/
...
/*
echo "<pre>";
print_r($admininsta->chtenie("fotvadmnke.txt")[0]);
echo "</pre>";
*/
