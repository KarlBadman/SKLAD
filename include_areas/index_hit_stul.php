...
$GLOBALS['arHitFilter'] = array(
    //"LOGIC" => "AND",
    array('PROPERTY_HIT' => 3050),
    //array('!CATALOG_QUANTITY' => 0)
);
?>
<div class="default">
    <div class="heading clearfix">
        <h2>Хиты продаж стульев</h2>
        <a class="border-link" href="/catalog/stulya/">Перейти в каталог стульев</a>
    </div>
</div>
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PAGER_TITLE" => "/include_areas/index_hit_stul.php",
