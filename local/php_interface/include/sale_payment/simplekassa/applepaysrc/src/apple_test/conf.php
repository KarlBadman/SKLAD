<?php
    ...
    define('PRODUCTION_DOMAINNAME', 'www.dsklad.ru'); //you can leave this line as-is too, it will take the domain from the server you run it on e.g. shop.mydomain.com or mydomain.com
    ...
    define('PRODUCTION_CURRENCYCODE', 'RUB');	// https://en.wikipedia.org/wiki/ISO_4217
    define('PRODUCTION_COUNTRYCODE', 'RU');		// https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2
