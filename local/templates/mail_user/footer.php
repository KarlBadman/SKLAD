...
<tr>
	...
	<td align="center" valign="middle" style="border-collapse: collapse;border-spacing: 0;padding: 44px 0 50px;vertical-align: middle;max-width: 693px;"><?
		...
		{
			?><a href="<?=CIntranetUtils::getB24Link('pub'); ?>" target="_blank" rel="noopener" style="color: #71a5b6;text-decoration: none;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size: 12px;display: inline-block;vertical-align: middle;"><?
