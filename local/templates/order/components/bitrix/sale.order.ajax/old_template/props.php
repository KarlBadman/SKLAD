...
?>
    <fieldset class="client ajaxreload">
        <div class="legend">
            <div class="title">
                <del class="hidden-s"><?=GetMessage("SOA_TEMPL_BUYER_INFO")?></del>
                <del class="hidden-gt-s"><?=GetMessage("SOA_TEMPL_BUYER_INFO")?></del>
            </div>
        </div>
        <div id="sale_order_props">
            ...
            PrintPropsForm($arResult["ORDER_PROP"]["GLOBAL_PROPS"], $arParams["TEMPLATE_LOCATION"],$arParams['PARAMS_USER'],$arResult["USER_VALS"]["PERSON_TYPE_ID"],$arResult['ERROR'],$arResult['SPAM'],$USER->IsAuthorized());
