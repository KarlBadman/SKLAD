...
<?if($arResult["NavPageNomer"] != $arResult["nEndPage"]):;?>
    <div class="show-more-btn">
        <button class="ds-btn ds-btn--light" data-name="next_page">Показать ещё</button>
    </div>
<?endif;?>
<div class="ds-pagination">
    ...
    <a class="ds-pagination__prev" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"></a>
        <?
        else:
        if ($arResult["NavPageCount"] == ($arResult["NavPageNomer"]+1) ):
        ?>

        <a class="ds-pagination__prev" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"></a>
            <?
            else:
            ?>
            ...
            <a class="ds-pagination__prev" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"></a>
                ...
                ?>
            <a class="ds-pagination__next" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>"></a>
