...
$MESS["CP_BCS_HIDE_NOT_AVAILABLE_EXT2"] = "Товары, недоступные для покупки";
...
$MESS["CP_BCS_HIDE_NOT_AVAILABLE_OFFERS"] = "Торговые предложения, недоступные для покупки";
...
$MESS["MAX_COUNT"] = "Максимальное количество элементов в выборке";
$MESS["ELEMENT_ID"] = "ID товара, для которого формируется выборка";
