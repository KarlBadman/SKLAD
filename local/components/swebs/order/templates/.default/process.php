...
<!--                            --><?//ppp($arItems)?>
        ...
        <div class="price"><span class="hidden-l">Цена за шт.</span>
            ...
            <?if($arItems['DISCOUNT_PRODUCT']['DISCOUNT_PERCENTAGE'] != '' && $arItems['DISCOUNT_PRODUCT']['DISCOUNT_PERCENTAGE'] != 0):?>
             <div class="sale__widget"><?=$arItems['DISCOUNT_PRODUCT']['DISCOUNT_PERCENTAGE']?>%
             </div>
             <?endif?>
        </div>
                                    </div>
