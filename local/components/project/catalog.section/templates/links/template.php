			...
			<table cellpadding="0" cellspacing="2" border="0">
				<tr>
					<?if(is_array($arElement["PREVIEW_PICTURE"])):?>
						<td valign="top">
						<a href="<?=$arElement["DETAIL_PAGE_URL"]?>" target="_blank" rel="noopener"><img
								border="0"
					...
					<?endif?>
					<td valign="top"><a href="<?=$arElement["DETAIL_PAGE_URL"]?>" target="_blank" rel="noopener"><?=$arElement["NAME"]?></a><br />
						<br />
