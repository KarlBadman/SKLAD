...
if (!defined('BX_YMAP_SCRIPT_LOADED'))
{
	...
	if(empty($arParams['KEY'])){
		$arParams['KEY'] = \Dsklad\Config::getParam('api_key/yandex_map');
	}

	$scheme = (CMain::IsHTTPS() ? "https" : "http");
	$arResult['MAPS_SCRIPT_URL'] = $scheme.'://api-maps.yandex.ru/'.$arParams['YANDEX_VERSION'].'/?apikey='.$arParams['KEY'].'&load=package.standard&mode=release&lang='.$arParams['LOCALE'].'&wizard=bitrix';
